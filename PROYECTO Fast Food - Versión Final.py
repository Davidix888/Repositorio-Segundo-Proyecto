...
class SistemaFacturacion:
    ...
    def registrar_usuario(self):
        ...
        if opcion_pago == '1':
            tarjeta_credito = input("Ingrese su número de tarjeta de crédito/débito | Formato (XXXX-XXXX-XXXX-XXXX): ")
    ...
    def generar_factura(self, nit_usuario, total):
        if nit_usuario in self.usuarios:
            ...
            if usuario.tarjeta_credito:
                contenido += f"Tarjeta de Crédito/Débito: XXXX-XXXX-XXXX-{tarjeta_oculta[-4:]}\n"
